            ...
            return (
                <TouchableOpacity onPress={() => { this.matchClicked(item) }}>
                    ...
                    <View style={{ flexDirection: 'row', alignItems: 'center', margin: 8.0 }}>
                        ...
                        <View style={{ backgroundColor: '#333333aa', borderRadius: 8, position: 'absolute', height: '100%', width: '100%', justifyContent: 'center', alignItems: 'flex-start', padding: 8.0 }}>
                            <Text numberOfLines={2} style={{ fontSize: 24.0, textAlign: 'center', color: Colors.text, fontFamily: Fonts.heading }}>{profile.fname} {profile.lname}</Text>
                        </View>
                    </View>
