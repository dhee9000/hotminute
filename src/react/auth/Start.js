    ...
    render() {
        return (
            <View style={{ flex: 1, backgroundColor: Colors.background, justifyContent: 'flex-start', alignItems: 'center' }}>
                    ...
                    <ScrollView contentContainerStyle={{ paddingHorizontal: 8.0 }}>
                        ...
                        <View style={{ flexDirection: 'row', flexWrap: 'wrap' }}>
                            <Text style={{ flex: 1, flexWrap: 'wrap' }}>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>1. Acceptance of Terms of Use Agreement.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>2. Eligibility.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>3. Your Account.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>4. Modifying the Service and Termination.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>5. Safety; Your Interactions with Other Members.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>6. Rights HotMinute - Dating Grants You.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>7. Rights you Grant HotMinute - Dating.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>8. Community Rules.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>9. Other Members’ Content.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>10. Notice and Procedure for Making Claims of Copyright Infringement.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>11. Disclaimers.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>12. Governing Law.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>13. Venue.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>14. Indemnity by You.{'\n'}</Text>
                                ...
                                < Text style={{ marginBottom: 16, fontFamily: Fonts.heading, fontSize: 20, justifyContent: 'center', alignItems: 'center', marginLeft: 100 }}>15. Entire Agreement; Other.{'\n'}</Text>
                ...
                <View style={{ paddingHorizontal: 16.0, alignSelf: 'stretch', alignContent: 'stretch', marginBottom: 16.0 }}>
                    <Text style={{fontSize: 10.0, textAlign: 'center'}}>Use of hotminute is subject to our Privacy Policy and Terms and Conditions.</Text>
